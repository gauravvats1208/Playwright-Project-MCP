Feature: SauceDemo E-commerce Testing
  ...
  Scenario Outline: Multiple user types login validation
    ...
    Examples:
      ...
      | standard_user          | secret_sauce | product inventory         |
      | locked_out_user        | secret_sauce | locked out error          |
      | problem_user           | secret_sauce | product inventory         |
      | performance_glitch_user| secret_sauce | product inventory         |
      | error_user             | secret_sauce | product inventory         |
      | visual_user            | secret_sauce | product inventory         |